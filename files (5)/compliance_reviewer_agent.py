...
RULEID = Literal[ "service_fee_waiver",
                  "wire_callback",
...
def search_knowledge_base(query: str, top_k: int = 5):
    ...
    # --- tracing: wraps the existing body, no logic change. This is the
    # now-fixed real implementation, replacing the previous version's
    # unrelated email-drafting stub -- no fix needed from this pass.
